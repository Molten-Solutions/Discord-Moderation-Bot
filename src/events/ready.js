module.exports = async (client) => {
  ...
  setInterval(() => {
    activities[1] = { name: `People @ Molten Solutions`, type: 'WATCHING' }; // Update server count
    activities[2] = { name: `${client.users.cache.size} users`, type: 'WATCHING' }; // Update user count
