...
module.exports = class RockPaperScissorsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Play a game of rock–paper–scissors against Froggy!',
  ...
  run(message, args) {
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**Froggy** wins!';
    ...
    const embed = new MessageEmbed()
      ...
      .addField('Froggy\'s Choice', res[botChoice], true)
